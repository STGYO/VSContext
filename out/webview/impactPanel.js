...
function openImpactPanel(result, logger, onOpenNode) {
    const panel = vscode.window.createWebviewPanel('vscontext.impactAnalysis', 'Impact Analysis Panel', vscode.ViewColumn.Beside, {
        enableScripts: true,
...
function renderImpactHtml(webview, result) {
